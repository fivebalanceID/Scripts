...
COIN_TGZ='http://syabiq.com/fbncd'
...
function create_key() {
  echo -e "Enter your ${RED}$COIN_NAME Masternode Private Key${NC} or Press Enter to generate a new ${RED}Masternode Private Key${NC} for you:"
  read -e COINKEY
  if [[ -z "$COINKEY" ]]; then
